...
export const manualMonthlyFormSteps: ManualMonthlyFormStep[] = [
  ...
  },
  {
    ...
    title: "Clientes y perfiles de laboratorio",
    description:
      "Reemplaza capacidad y equipo para Laboratorio: captura los KPIs de clientes, ordenes, perfiles y roles operativos que vienen de la plantilla de resultados.",
    ownerNote:
      "Estos campos alimentan flujo de pacientes, demanda, productividad por perfil y lectura comercial de Laboratorio.",
    fields: [
      {
        id: "lab_unique_clients",
        label: "Clientes unicos",
        description: "Clientes anonimos distintos atendidos durante el mes.",
        inputType: "number",
        unit: "clientes",
        required: true,
        placeholder: "0",
      ...
      },
      {
        ...
        description: "Clientes que aparecen por primera vez en el periodo.",
        inputType: "number",
        unit: "clientes",
        required: true,
        placeholder: "0",
      ...
      {
        id: "lab_recurring_clients",
        label: "Clientes recurrentes",
        description: "Clientes que ya habian comprado en meses anteriores.",
        inputType: "number",
        unit: "clientes",
        required: true,
        placeholder: "0",
      ...
      {
        id: "lab_reactivated_clients",
        label: "Clientes reactivados",
        description: "Clientes que volvieron despues de estar inactivos.",
        inputType: "number",
        unit: "clientes",
        required: false,
        placeholder: "0",
      ...
      {
        id: "lab_orders_per_client",
        label: "Ordenes por cliente",
        description: "Promedio de ordenes por cliente en el periodo.",
        inputType: "number",
        unit: "ordenes/cliente",
        required: true,
        placeholder: "0",
        appliesTo: ["Laboratorio"],
        min: 0,
      ...
      {
        id: "lab_profiles_processed",
        label: "Perfiles procesados",
        description: "Cantidad de perfiles o paquetes de laboratorio vendidos/procesados.",
        inputType: "number",
        unit: "perfiles",
        required: true,
        placeholder: "0",
      ...
      {
        id: "lab_top_profiles",
        label: "Perfiles principales",
        description: "Lista corta de los perfiles mas vendidos o mas relevantes del mes.",
        inputType: "text",
        unit: "texto",
        required: false,
        placeholder: "Ej. Hemograma, Perfil lipidico, Glucosa",
        appliesTo: ["Laboratorio"],
      },
      {
        id: "lab_active_phlebotomists",
        label: "Flebotomistas activos",
        description: "Numero de flebotomistas que trabajaron en la sucursal durante el mes.",
        inputType: "number",
        unit: "personas",
        required: true,
        placeholder: "0",
      ...
      {
        id: "lab_active_lab_technicians",
        label: "Tecnicos de laboratorio activos",
        description: "Numero de tecnicos que procesaron muestras o pruebas.",
        inputType: "number",
        unit: "personas",
        required: true,
        placeholder: "0",
      ...
      {
        id: "lab_active_receptionists",
        label: "Recepcionistas activas",
        description: "Personal de recepcion que participo en captura, facturacion o atencion.",
        inputType: "number",
        unit: "personas",
        required: false,
        placeholder: "0",
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        description: "Unidades o conteo de consumibles disponibles o consumidos en el cierre.",
        inputType: "number",
        unit: "unidades",
        required: true,
        placeholder: "0",
      ...
      },
      {
        ...
        description: "Unidades o conteo de insumos disponibles o consumidos en el cierre.",
        inputType: "number",
        unit: "unidades",
        required: true,
        placeholder: "0",
      ...
      },
      {
        ...
        description: "Unidades, lotes o conteo de reactivos disponibles o consumidos.",
        inputType: "number",
        unit: "unidades",
        required: true,
        placeholder: "0",
      ...
      },
      {
        ...
        description: "Monto mensual asociado a reactivos. AnaliA lo comparara contra venta, pruebas y costo directo.",
        inputType: "currency",
        unit: "USD",
        required: true,
        placeholder: "0.00",
  ...
  },
  {
    ...
    title: "Archivos comerciales y validacion automatica",
    description:
      "Carga archivos comerciales clave y deja que AnaliA calcule calidad, coherencia y alertas sospechosas.",
    ownerNote:
      "La calidad ya no se escribe a mano: AnaliA valida montos, archivos, sucursal, fechas, duplicados y coherencia contra KPIs.",
    fields: [
      {
        id: "doctors_sales_file",
        label: "Excel doctores y montos vendidos",
        description: "Archivo mensual con doctor, especialidad, examen, monto vendido y sucursal.",
        inputType: "file",
        unit: ".xlsx",
        required: true,
        placeholder: "Selecciona archivo de doctores",
        appliesTo: ["Laboratorio"],
      },
      {
        id: "medical_reps_sales_file",
        label: "Excel visitadores medicos",
        description: "Archivo mensual con visitador, doctores asociados, ventas, zona y seguimiento.",
        inputType: "file",
        unit: ".xlsx",
        required: true,
        placeholder: "Selecciona archivo de visitadores",
        appliesTo: ["Laboratorio"],
      },
      {
        id: "late_reason",
