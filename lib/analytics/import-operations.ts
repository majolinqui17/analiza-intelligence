...
export const manualMonthlyFormSteps: ManualMonthlyFormStep[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      {
        id: "lab_goal_completion_rate",
        label: "Alcance % de la meta",
        description: "Porcentaje de cumplimiento de la meta mensual.",
        inputType: "percent",
        unit: "%",
        required: true,
        placeholder: "0",
      ...
      {
        id: "lab_sales_without_tax",
        label: "Venta sin IVA",
        description: "Venta neta sin IVA para analisis financiero.",
        inputType: "currency",
        unit: "USD",
        required: true,
        placeholder: "0.00",
      ...
      },
      {
        ...
        description: "Margen porcentual del cierre mensual.",
        inputType: "percent",
        unit: "%",
        required: true,
        placeholder: "0",
      ...
      {
        id: "lab_margin_amount",
        label: "Margen Absoluto ($.)",
        description: "Margen absoluto reportado en dolares.",
        inputType: "currency",
        unit: "USD",
        required: true,
        placeholder: "0.00",
      ...
      {
        id: "lab_operating_profit",
        label: "Utilidad operativa",
        description: "Utilidad operativa del mes.",
        inputType: "currency",
        unit: "USD",
        required: true,
        placeholder: "0.00",
      ...
      {
        id: "lab_operating_profit_rate",
        label: "Utilidad operativa %",
        description: "Utilidad operativa como porcentaje de venta.",
        inputType: "percent",
        unit: "%",
        required: true,
        placeholder: "0",
  ...
  {
    id: "personal-perfiles-laboratorio",
    title: "Personal y perfiles",
    description:
      "Personal asignado y total de perfiles capturados desde los campos amarillos.",
    ownerNote:
      "El total de personal asignado se calcula con los cargos ingresados; los perfiles quedan como dato mensual de operacion.",
    fields: [
      {
      ...
      {
        id: "lab_profiles_total",
        label: "Total perfiles",
        description: "Total de perfiles reportados en el cierre mensual.",
        inputType: "number",
        unit: "perfiles",
        required: true,
        placeholder: "0",
